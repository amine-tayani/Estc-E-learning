...
<body>
  ...
  <section class="slider" id="home">
    <ul class="slidr-carousel" id="slider-carousel">
      <li class="img1">
        <h2 style="font-size: 50px;">{{$td->titre}} </h2>
        <p> <br> </p>
      </li>
    </ul>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 text-center">
          <h5 class="wow bounceInDown" data-wow-duration="1s" data-wow-delay="1s"> Description : {{$td->contenu}}</h5>
        </div>
      </div>
    </div>
  </section>
  <div style="margin-left: 22%">
    <embed src="/storage/td/{{$td->pdf}}" type="application/pdf" width="70%" height="800px" />
  </div>
